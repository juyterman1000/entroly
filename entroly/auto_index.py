...
SKIP_PATTERNS = frozenset({
    ...
    ".DS_Store", "thumbs.db",
    # Generated by `entroly verify-claims`. It is evidence about Entroly's
    # smoke test, not source evidence for the user's next task.
...
def _priority_score(rel_path: str) -> int:
    ...
    if _has_skipped_dir(rel_path) or any(
        name == pattern.lower() for pattern in SKIP_PATTERNS
    ):
        return 5
