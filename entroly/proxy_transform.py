...
injecting optimized context, and keeping provider request controls intact.

Request-side sampling controls are pass-through by design. Entroly does not
rewrite temperature, thinking, or similar provider-owned generation settings.
