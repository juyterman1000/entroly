...
60 frozen SQuAD v2 long-context trials; Entroly 1.0.59 source candidate vs released External Baseline A 0.31.0; achieved ratios use `o200k_base`.
Active-context scope: External Baseline A's CCR pointers remain in its output, but retrieval recovery is not invoked; this is not an end-to-end External Baseline A CCR comparison.
