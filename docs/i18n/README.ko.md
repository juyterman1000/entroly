...
모든 AI 코딩 도구 — Claude, Cursor, Codex, Aider — 는 같은 맹점이 있습니다: **한 번에 5~10개 파일만 봅니다.** 나머지 95%의 코드베이스는 보이지 않습니다.
...
|---|---|---|
| AI가 보는 파일 | 5–10 | **지원되는 파일을 가변 해상도로 선택** |
...
끝. Entroly가 IDE를 자동 감지하고 Claude/Cursor/Codex/Aider에 연결하여 최적화를 시작합니다.
