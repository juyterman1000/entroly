...
Publication is retriggered from the repaired main branch after fixing the
release-wide Python prerelease assertion and GitHub commit-identity gate.
The package workflow is idempotent and skips any artifact already present.
